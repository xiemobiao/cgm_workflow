...
const MESSAGES: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'logs.files.backToFiles': '返回文件列表',
    'logs.files.backToDetail': '返回文件详情',
    'logs.files.viewContent': '查看文件内容',
    'logs.files.analysisAutomation': '分析自动化',
    'logs.files.eventFlowAnalysis': '事件流分析',
    'logs.files.quickLinks': '快捷入口',
    'logs.files.fileInfo': '文件信息',
    'logs.files.coverage': '覆盖率',
    'logs.files.overview.totalEvents': '事件总数',
    'logs.files.overview.totalErrors': '错误数量',
    'logs.files.overview.bleQualityHit': 'BLE 性能日志命中',
    'logs.files.uploadedAt': '上传时间',
    'logs.files.fileName': '文件名',
    'logs.files.status': '状态',
    'logs.files.events': '事件数',
    'logs.files.errors': '错误数',
    'logs.files.quality': '质量',
    'logs.files.analysisStatus.analyzing': '分析中',
    'logs.files.analysisStatus.failed': '分析失败',
    ...
    'logs.files.viewerEnd': '已加载全部',
    'logs.files.openInLogs': '在日志中查看事件',
    'logs.files.delete': '删除文件',
    'logs.files.deleteConfirm':
      '确认删除日志文件"{fileName}"？这将删除相关事件数据与关联关系，且不可恢复。',
    'logs.files.batchDelete': '删除选中 ({count})',
    'logs.files.batchDeleteConfirm':
      '确认删除选中的 {count} 个日志文件？这将删除相关事件数据与关联关系，且不可恢复。',
    'logs.files.selectAll': '全选',
    'logs.files.selectFile': '选择文件 {fileName}',
    'logs.files.onlyErrors': '只显示错误',
    'logs.files.filteredItems': '显示 {filtered} / {total} 条',
    ...
    'logs.files.bleQuality.tab.present': '已出现',
    ...
    'logs.appId': '应用 ID',
    'logs.trace': '追踪',
    'logs.trace.description': '按 linkCode / requestId / attemptId / 设备信息追踪完整事件链路。',
    'logs.trace.type': '追踪类型',
    'logs.trace.value': '追踪值',
    'logs.trace.logFileIdPlaceholder': '按 logFileId 过滤（可选）',
    'logs.trace.timeline': '时间线',
    'logs.trace.device': '设备',
    'logs.trace.deviceSn': '设备 SN',
    'logs.trace.linkCode': '关联码',
    'logs.trace.requestId': '请求ID',
    'logs.trace.errorCode': '错误码',
    'logs.trace.thread': '线程',
    'logs.trace.type.linkCode': '关联码',
    'logs.trace.type.linkCodePlaceholder': '例如 abc123',
    'logs.trace.type.requestId': '请求ID',
    'logs.trace.type.requestIdPlaceholder': '例如 req-001',
    'logs.trace.type.attemptId': 'attemptId',
    'logs.trace.type.attemptIdPlaceholder': '例如 123e4567-e89b-12d3-a456-426614174000',
    'logs.trace.type.deviceMac': '设备 MAC',
    'logs.trace.type.deviceMacPlaceholder': '例如 AA:BB:CC:DD:EE:FF',
    'logs.trace.type.deviceSn': '设备 SN',
    'logs.trace.type.deviceSnPlaceholder': '例如 SN12345678',
    'logs.stats': '统计',
    'logs.stats.description': '统计日志事件分布、错误热区与关键趋势。',
    'logs.stats.totalEvents': '事件总数',
    'logs.stats.errorRate': '错误率',
    'logs.stats.eventTypes': '事件类型数',
    'logs.stats.levelDistribution': '级别分布',
    'logs.stats.topEvents': '高频事件',
    'logs.stats.moreEvents': '更多事件',
    'logs.stats.errorHotspots': '错误热区',
    'logs.stats.count': '次数',
    'logs.stats.lastSeen': '最近出现',
    'logs.eventsDetail.mainThread': '主线程',
    'logs.eventsDetail.bgThread': '后台线程',
    'logs.eventsDetail.sdkVersion': 'SDK 版本',
    'logs.eventsDetail.appId': '应用 ID',
    'logs.eventsDetail.terminalInfo': '终端信息',
    'logs.eventsDetail.eventId': '事件 ID',
    'logs.eventsDetail.logFileId': '日志文件 ID',
    'logs.eventsDetail.copyAttemptId': '复制 attemptId',
    ...
    'logs.onlyErrors': '只显示错误',
    'logs.detail.title': '事件详情',
    'logs.detail.close': '关闭',
    'logs.detail.copyEventId': '复制事件 ID',
    'logs.detail.copyLogFileId': '复制 logFileId',
    'logs.detail.traceLinkCode': '追踪 linkCode',
    'logs.detail.traceRequestId': '追踪 requestId',
    'logs.detail.traceAttemptId': '追踪 attemptId',
    'logs.detail.traceDeviceMac': '追踪 deviceMac',
    'logs.detail.traceDeviceSn': '追踪 deviceSn',
    'logs.detail.openCommands': '查看命令链路',
    'logs.detail.context': '上下文',
    'logs.detail.current': '当前事件',
    'logs.detail.contextEmpty': '无上下文',
    'logs.detail.ids': 'ID 信息',
    ...
    'logs.commands.status.success': '成功',
    'logs.commands.status.timeout': '超时',
    'logs.commands.status.error': '错误',
    'logs.commands.status.pending': '待定',
    ...
    'logs.bluetooth.title': '蓝牙调试中心',
    'logs.bluetooth.sessionsCount': '{count} 个会话',
    'logs.bluetooth.aggregateSessions': '聚合会话',
    'logs.bluetooth.aggregateResult': '已聚合会话：{count}',
    'logs.bluetooth.commandChains': '命令链路',
    'logs.bluetooth.totalPatterns': '模式总数',
    'logs.bluetooth.highSeverity': '高严重度',
    'logs.bluetooth.affectedDevices': '影响设备',
    'logs.bluetooth.anomalyPatterns': '异常模式',
    'logs.bluetooth.errorDistribution': '错误分布',
    'logs.bluetooth.severity': '严重度',
    'logs.bluetooth.occurrences': '出现次数',
    'logs.bluetooth.sessions': '会话数',
    'logs.bluetooth.avgInterval': '平均间隔',
    'logs.bluetooth.percentage': '占比',
    'logs.bluetooth.distribution': '分布',
    'logs.bluetooth.totalWithCount': '总计 {count}',
    'logs.bluetooth.severityLevel': '等级 {level}',
    'logs.bluetooth.unknown': '未知',
    'logs.bluetooth.emptySessions': '暂无会话，请先执行“聚合会话”或调整时间范围。',
    'logs.bluetooth.emptySessionsWithFile': '该日志文件暂无会话，请调整时间范围或筛选条件。',
    'logs.bluetooth.emptyCommandChains': '暂无命令链路，请调整时间范围后重试。',
    'logs.bluetooth.emptyAnomalies': '未检测到异常模式。',
    'logs.bluetooth.emptyErrors': '当前时间范围内未发现错误。',
    'logs.bluetooth.tab.sessions': '会话',
    'logs.bluetooth.tab.commands': '命令',
    'logs.bluetooth.tab.anomalies': '异常',
    'logs.bluetooth.tab.errors': '错误',
    'logs.bluetooth.tab.compare': '对比',
    'logs.bluetooth.tab.timeline': '时间线',
    'logs.bluetooth.tab.events': '事件',
    'logs.bluetooth.status.scanning': '扫描中',
    'logs.bluetooth.status.pairing': '配对中',
    'logs.bluetooth.status.connecting': '连接中',
    'logs.bluetooth.status.connected': '已连接',
    'logs.bluetooth.status.communicating': '通信中',
    'logs.bluetooth.status.disconnected': '已断开',
    'logs.bluetooth.status.timeout': '超时',
    'logs.bluetooth.status.error': '错误',
    'logs.bluetooth.anomalyType.frequentDisconnect': '频繁断连',
    'logs.bluetooth.anomalyType.timeoutRetry': '超时重试',
    'logs.bluetooth.anomalyType.errorBurst': '错误突增',
    'logs.bluetooth.anomalyType.slowConnection': '连接缓慢',
    'logs.bluetooth.anomalyType.commandFailure': '命令失败',
    'logs.bluetooth.sessionDetail': '会话详情',
    'logs.bluetooth.sessionOverview': '会话概览',
    'logs.bluetooth.missingProjectId': '缺少 projectId 参数，无法加载会话详情。',
    'logs.bluetooth.backToSessions': '返回会话列表',
    'logs.bluetooth.viewAllEvents': '查看全部事件',
    'logs.bluetooth.noCommandChainsInSession': '当前会话未发现命令链路。',
    ...
    'logs.files.diagnosis.title': '问题诊断',
    'logs.files.diagnosis.description': '自动匹配已知问题，快速定位线上故障',
    'logs.files.diagnosis.noIssues': '未发现问题',
    'logs.files.diagnosis.totalErrors': '错误总数',
    'logs.files.diagnosis.matchedIssues': '匹配问题',
    'logs.files.diagnosis.critical': '严重',
    'logs.files.diagnosis.warning': '警告',
    'logs.files.diagnosis.occurrences': '次',
    'logs.files.diagnosis.devices': '设备',
    'logs.files.diagnosis.sessions': '会话',
    'logs.files.diagnosis.solution': '解决方案',
    'logs.files.diagnosis.viewEvents': '查看事件',
    'logs.files.diagnosis.traceSession': '追踪会话',
    'logs.files.diagnosis.traceDevice': '追踪设备',
    'logs.files.diagnosis.moreIssues': '还有 {count} 个问题...',
    'logs.files.diagnosis.unmatchedErrors': '发现 {count} 个错误，但未匹配到已知问题',
    'logs.files.diagnosis.viewAllErrors': '查看所有错误',
    'logs.files.diagnosis.noErrorsFound': '未发现任何错误事件',

    'logs.analysis.title': '日志分析面板',
    'logs.analysis.subtitle': '自动化质量分析与诊断',
    'logs.analysis.invalidLogFileId': '无效的日志文件 ID',
    'logs.analysis.actions.reanalyze': '重新分析',
    'logs.analysis.actions.startNow': '立即分析',
    'logs.analysis.actions.retry': '重试',
    'logs.analysis.actions.refreshAutomation': '刷新自动化数据',
    'logs.analysis.error.title': '分析错误',
    'logs.analysis.error.retryAnalysis': '重试分析',
    'logs.analysis.empty.title': '尚未分析',
    'logs.analysis.empty.description': '该日志文件尚未进行自动化质量分析',
    'logs.analysis.status.analyzingTitle': '分析进行中',
    'logs.analysis.status.analyzingDescription': '当前正在执行分析，结果会自动刷新。',
    'logs.analysis.status.failedTitle': '分析失败',
    'logs.analysis.status.unknownError': '未知错误',
    'logs.analysis.metrics.overallQualityScore': '整体质量评分',
    'logs.analysis.metrics.totalEvents': '事件总数',
    'logs.analysis.metrics.errors': '错误数',
    'logs.analysis.metrics.warnings': '警告数',
    'logs.analysis.metrics.sessions': '会话数',
    'logs.analysis.metrics.devices': '设备数',
    'logs.analysis.severity.critical': '严重',
    'logs.analysis.severity.high': '高',
    'logs.analysis.severity.medium': '中',
    'logs.analysis.severity.low': '低',
    'logs.analysis.assertions.title': '断言自动化',
    'logs.analysis.assertions.actions.installing': '安装中...',
    'logs.analysis.assertions.actions.installDefaults': '安装默认规则',
    'logs.analysis.assertions.actions.running': '执行中...',
    'logs.analysis.assertions.actions.runNow': '立即执行断言',
    'logs.analysis.assertions.empty': '暂无断言运行记录。你可以先安装默认规则，再手动执行一次断言。',
    'logs.analysis.assertions.table.triggeredBy': '触发方式',
    'logs.analysis.assertions.table.passRate': '通过率',
    'logs.analysis.assertions.table.passed': '通过',
    'logs.analysis.assertions.table.failed': '失败',
    'logs.analysis.assertions.pass': '通过',
    'logs.analysis.assertions.status.completed': '已完成',
    'logs.analysis.assertions.status.running': '运行中',
    'logs.analysis.assertions.status.failed': '失败',
    'logs.analysis.assertions.trigger.manual': '手动',
    'logs.analysis.assertions.trigger.auto': '自动',
    'logs.analysis.assertions.summary.installDefaults':
      '默认规则安装完成：新增 {created}，已存在 {skipped}。',
    'logs.analysis.assertions.summary.pass': '断言通过：{passed}/{total}，通过率 {rate}%。',
    'logs.analysis.assertions.summary.fail': '断言未通过：{failed}/{total} 条失败。',
    'logs.analysis.projectContextLoading': '正在解析项目上下文，请稍后再试。',
    'logs.analysis.regression.title': '回归趋势（相对基线）',
    'logs.analysis.regression.baselineMissingHint': '暂无激活的回归基线，请先创建基线后查看趋势。',
    'logs.analysis.regression.baselineLabel': '基线：{baseline}',
    'logs.analysis.regression.thresholdHint':
      'Quality 最大下降 {qualityDrop}，ErrorRate 最大上升 {errorRateIncrease}',
    'logs.analysis.regression.pass': '通过',
    'logs.analysis.regression.failWithCount': '失败（{count}）',
    'logs.analysis.regression.deltaQuality': 'Δ 质量:',
    'logs.analysis.regression.deltaErrorRate': 'Δ 错误率:',
    'logs.analysis.regression.deltaErrors': 'Δ 错误数:',
    'logs.analysis.regression.deltaWarnings': 'Δ 警告数:',
    'logs.analysis.regression.topViolation': 'Top 违规：{message}',
    'logs.analysis.reasonCode.title': '断连原因分类（reasonCode）',
    'logs.analysis.reasonCode.subtitle':
      '聚合 reasonCode 并按 stage/op/result 分类，快速定位主因。',
    'logs.analysis.reasonCode.totalTagged': '已标记 reasonCode',
    'logs.analysis.reasonCode.coverage': '覆盖率',
    'logs.analysis.reasonCode.missing': '缺失 reasonCode',
    'logs.analysis.reasonCode.unique': '原因码种类',
    'logs.analysis.reasonCode.topReasons': 'Top 原因码',
    'logs.analysis.reasonCode.categories': '分类分布',
    'logs.analysis.reasonCode.stageOpResult': 'stage/op/result 组合 Top',
    'logs.analysis.reasonCode.empty': '当前日志文件没有可聚合的 reasonCode。',
    'logs.analysis.reasonCode.reason': 'reasonCode',
    'logs.analysis.reasonCode.category': '分类',
    'logs.analysis.reasonCode.count': '次数',
    'logs.analysis.reasonCode.ratio': '占比',
    'logs.analysis.reasonCode.topReasonHint': 'Top: {reasonCode}（{count}）',
    'logs.analysis.reasonCode.unknownValue': '-',
    'logs.analysis.reasonCode.category.timeout': '超时',
    'logs.analysis.reasonCode.category.permission': '权限/鉴权',
    'logs.analysis.reasonCode.category.network': '网络/云端',
    'logs.analysis.reasonCode.category.bluetooth': '蓝牙链路',
    'logs.analysis.reasonCode.category.data': '数据/上传',
    'logs.analysis.reasonCode.category.session': '连接会话',
    'logs.analysis.reasonCode.category.device': '设备标识',
    'logs.analysis.reasonCode.category.unknown': '其他',
    'logs.analysis.ble.title': 'BLE 质量报告',
    'logs.analysis.ble.coverage': '覆盖率',
    'logs.analysis.ble.requiredEvents': '必需事件',
    'logs.analysis.ble.ok': '命中',
    'logs.analysis.ble.missing': '缺失',
    'logs.analysis.ble.parserErrors': '解析错误',
    'logs.analysis.ble.loganDecryption': 'Logan 解密',
    'logs.analysis.ble.succeeded': '成功',
    'logs.analysis.backend.title': '后端质量报告',
    'logs.analysis.backend.httpRequests': 'HTTP 请求',
    'logs.analysis.backend.total': '总数',
    'logs.analysis.backend.success': '成功',
    'logs.analysis.backend.failed': '失败',
    'logs.analysis.backend.successRate': '成功率',
    'logs.analysis.backend.mqtt': 'MQTT',
    'logs.analysis.backend.connected': '已连接',
    'logs.analysis.backend.publishSuccess': '发布成功',
    'logs.analysis.backend.publishFailed': '发布失败',
    'logs.analysis.backend.ackTimeout': 'ACK 超时',
    'logs.analysis.anomalies.title': '异常检测（{count}）',
    'logs.analysis.anomalies.occurrences': '{count} 次',
    'logs.analysis.anomalies.affectedSessions': '影响会话：{count}',
    'logs.analysis.knownIssues.title': '已匹配已知问题（{count}）',
    'logs.analysis.knownIssues.confidence': '置信度 {percent}%',
    'logs.analysis.knownIssues.solution': '解决方案',
    'logs.analysis.knownIssues.matchedEvents': '匹配到 {count} 个事件',
    'logs.eventFlow.title': '事件流分析',
    'logs.eventFlow.subtitle': '分析日志文件中的事件链路和覆盖情况',
    'logs.eventFlow.loading': '正在加载事件流分析...',
    'logs.eventFlow.loadFailed': '加载失败',
    'logs.eventFlow.emptyTitle': '暂无数据',
    'logs.eventFlow.emptyDescription': '该日志文件尚未进行事件流分析',
    'logs.eventFlow.analyzeNow': '立即分析',
    'logs.eventFlow.triggerFailed': '触发分析失败',
    'logs.eventFlow.unknownError': '未知错误',
    'logs.eventFlow.tab.mainFlow': '主链路分析',
    'logs.eventFlow.tab.coverage': '事件覆盖检查',
    'logs.eventFlow.common.na': 'N/A',
    'logs.eventFlow.mainFlow.totalSessions': '总会话数',
    'logs.eventFlow.mainFlow.completedSessions': '完成会话',
    'logs.eventFlow.mainFlow.completionRate': '完成率',
    'logs.eventFlow.mainFlow.avgDuration': '平均耗时',
    'logs.eventFlow.mainFlow.stageAnalysis': '阶段分析',
    'logs.eventFlow.mainFlow.sampleSessions.title': '示例会话',
    'logs.eventFlow.mainFlow.sampleSessions.description': '显示部分会话的详细分析结果',
    'logs.eventFlow.mainFlow.table.linkCode': 'LinkCode',
    'logs.eventFlow.mainFlow.table.deviceMac': '设备 MAC',
    'logs.eventFlow.mainFlow.table.totalDuration': '总耗时',
    'logs.eventFlow.mainFlow.table.completedStages': '完成阶段',
    'logs.eventFlow.mainFlow.table.coverage': '覆盖率',
    'logs.eventFlow.mainFlow.table.status': '状态',
    'logs.eventFlow.mainFlow.status.completed': '完成',
    'logs.eventFlow.mainFlow.status.incomplete': '未完成',
    'logs.eventFlow.stage.required': '必需',
    'logs.eventFlow.stage.expectedDuration': '预期耗时',
    'logs.eventFlow.stage.sessions': '{covered} / {total} 会话',
    'logs.eventFlow.stage.avgDuration': '平均耗时',
    'logs.eventFlow.stage.maxDuration': '最大耗时',
    'logs.eventFlow.stage.minDuration': '最小耗时',
    'logs.eventFlow.stage.eventsList': '事件列表',
    'logs.eventFlow.stage.table.eventName': '事件名称',
    'logs.eventFlow.stage.table.required': '必需',
    'logs.eventFlow.stage.table.occurrenceCount': '出现次数',
    'logs.eventFlow.stage.table.hitSessions': '命中会话',
    'logs.eventFlow.stage.table.missedSessions': '缺失会话',
    'logs.eventFlow.stage.table.hitRate': '命中率',
    'logs.eventFlow.stage.optional': '可选',
    'logs.eventFlow.stage.issuesTitle': '发现的问题',
    'logs.eventFlow.stage.severity': '严重度: {severity}',
    'logs.eventFlow.stage.affectedSessions': '影响会话: {count} 个',
    'logs.eventFlow.coverage.totalEvents': '总事件数',
    'logs.eventFlow.coverage.knownEvents': '已知事件',
    'logs.eventFlow.coverage.coveredEvents': '覆盖事件',
    'logs.eventFlow.coverage.missingCount': '缺失 {count} 个',
    'logs.eventFlow.coverage.coverageRate': '覆盖率',
    'logs.eventFlow.coverage.categoryCoverage': '分类覆盖统计',
    'logs.eventFlow.coverage.extraEvents.title': '额外事件',
    'logs.eventFlow.coverage.extraEvents.description':
      '日志中出现但不在已知事件列表中的事件（共 {count} 个）',
    'logs.eventFlow.coverage.extraEvents.table.eventName': '事件名称',
    'logs.eventFlow.coverage.extraEvents.table.occurrenceCount': '出现次数',
    'logs.eventFlow.coverage.extraEvents.showingLimit': '仅显示前 20 个，共 {count} 个额外事件',
    'logs.eventFlow.coverage.categoryEvents': '{covered} / {total} 事件',
    'logs.eventFlow.coverage.categoryTable.eventName': '事件名称',
    'logs.eventFlow.coverage.categoryTable.level': '级别',
    'logs.eventFlow.coverage.categoryTable.description': '说明',
    'logs.eventFlow.coverage.categoryTable.occurrenceCount': '出现次数',
    'logs.eventFlow.coverage.categoryTable.status': '状态',
    'logs.eventFlow.coverage.status.covered': '已覆盖',
    'logs.eventFlow.coverage.status.missing': '未出现',
  },
  en: {
    ...
    'logs.files.backToFiles': 'Back to files',
    'logs.files.backToDetail': 'Back to detail',
    'logs.files.viewContent': 'View content',
    'logs.files.analysisAutomation': 'Analysis automation',
    'logs.files.eventFlowAnalysis': 'Event flow analysis',
    'logs.files.quickLinks': 'Quick links',
    'logs.files.fileInfo': 'File info',
    'logs.files.coverage': 'Coverage',
    'logs.files.overview.totalEvents': 'Total events',
    'logs.files.overview.totalErrors': 'Total errors',
    'logs.files.overview.bleQualityHit': 'BLE quality hits',
    ...
    'logs.files.quality': 'Quality',
    'logs.files.analysisStatus.analyzing': 'Analyzing',
    'logs.files.analysisStatus.failed': 'Failed',
    ...
    'logs.files.viewerEnd': 'All loaded',
    ...
    'logs.files.batchDelete': 'Delete Selected ({count})',
    'logs.files.batchDeleteConfirm':
      'Delete {count} selected log files? This will remove related events and links and cannot be undone.',
    'logs.files.selectAll': 'Select all',
    'logs.files.selectFile': 'Select file {fileName}',
    'logs.files.onlyErrors': 'Errors only',
    'logs.files.filteredItems': 'Showing {filtered} / {total}',
    ...
    'logs.files.bleQuality.tab.present': 'Present',
    ...
    'logs.appId': 'App ID',
    'logs.trace': 'Trace',
    'logs.trace.description': 'Trace full event chains by linkCode / requestId / attemptId / device identifiers.',
    'logs.trace.type': 'Trace Type',
    'logs.trace.value': 'Value',
    'logs.trace.logFileIdPlaceholder': 'Filter by logFileId (optional)',
    'logs.trace.timeline': 'Timeline',
    'logs.trace.device': 'Device',
    'logs.trace.deviceSn': 'Device SN',
    'logs.trace.linkCode': 'Link Code',
    'logs.trace.requestId': 'Request ID',
    'logs.trace.errorCode': 'Error Code',
    'logs.trace.thread': 'Thread',
    'logs.trace.type.linkCode': 'Link Code',
    'logs.trace.type.linkCodePlaceholder': 'e.g. abc123',
    'logs.trace.type.requestId': 'Request ID',
    'logs.trace.type.requestIdPlaceholder': 'e.g. req-001',
    'logs.trace.type.attemptId': 'Attempt ID',
    'logs.trace.type.attemptIdPlaceholder': 'e.g. 123e4567-e89b-12d3-a456-426614174000',
    'logs.trace.type.deviceMac': 'Device MAC',
    'logs.trace.type.deviceMacPlaceholder': 'e.g. AA:BB:CC:DD:EE:FF',
    'logs.trace.type.deviceSn': 'Device SN',
    'logs.trace.type.deviceSnPlaceholder': 'e.g. SN12345678',
    'logs.stats': 'Stats',
    'logs.stats.description': 'Inspect event distribution, error hotspots, and trend metrics.',
    'logs.stats.totalEvents': 'Total Events',
    'logs.stats.errorRate': 'Error Rate',
    'logs.stats.eventTypes': 'Event Types',
    'logs.stats.levelDistribution': 'Level Distribution',
    'logs.stats.topEvents': 'Top Events',
    'logs.stats.moreEvents': 'more events',
    'logs.stats.errorHotspots': 'Error Hotspots',
    'logs.stats.count': 'Count',
    'logs.stats.lastSeen': 'Last Seen',
    'logs.eventsDetail.mainThread': 'main',
    'logs.eventsDetail.bgThread': 'background',
    'logs.eventsDetail.sdkVersion': 'SDK Version',
    'logs.eventsDetail.appId': 'App ID',
    'logs.eventsDetail.terminalInfo': 'Terminal Info',
    'logs.eventsDetail.eventId': 'Event ID',
    'logs.eventsDetail.logFileId': 'Log File ID',
    'logs.eventsDetail.copyAttemptId': 'Copy attemptId',
    ...
    'logs.detail.traceLinkCode': 'Trace linkCode',
    'logs.detail.traceRequestId': 'Trace requestId',
    'logs.detail.traceAttemptId': 'Trace attemptId',
    'logs.detail.traceDeviceMac': 'Trace deviceMac',
    'logs.detail.traceDeviceSn': 'Trace deviceSn',
    'logs.detail.openCommands': 'Open commands',
    ...
    'logs.viewDiagnosis': 'View Diagnosis',
    ...
    'logs.empty':
      'No data. Expand the time range or wait for parsing; failures show as eventName=PARSER_ERROR.',
	    ...
	    'logs.excludeNoisy': 'Exclude noisy events',
    ...
    'logs.commands.deviceMacOptional': 'deviceMac (optional)',
    ...
    'logs.commands.status.success': 'Success',
    'logs.commands.status.timeout': 'Timeout',
    'logs.commands.status.error': 'Error',
    'logs.commands.status.pending': 'Pending',
    ...
    'logs.bluetooth.title': 'Bluetooth Debug Center',
    'logs.bluetooth.sessionsCount': '{count} sessions',
    'logs.bluetooth.aggregateSessions': 'Aggregate Sessions',
    'logs.bluetooth.aggregateResult': 'Aggregated sessions: {count}',
    'logs.bluetooth.commandChains': 'Command Chains',
    'logs.bluetooth.totalPatterns': 'Total Patterns',
    'logs.bluetooth.highSeverity': 'High Severity',
    'logs.bluetooth.affectedDevices': 'Affected Devices',
    'logs.bluetooth.anomalyPatterns': 'Anomaly Patterns',
    'logs.bluetooth.errorDistribution': 'Error Distribution',
    'logs.bluetooth.severity': 'Severity',
    'logs.bluetooth.occurrences': 'Occurrences',
    'logs.bluetooth.sessions': 'Sessions',
    'logs.bluetooth.avgInterval': 'Avg Interval',
    'logs.bluetooth.percentage': 'Percentage',
    'logs.bluetooth.distribution': 'Distribution',
    'logs.bluetooth.totalWithCount': '{count} total',
    'logs.bluetooth.severityLevel': 'Level {level}',
    'logs.bluetooth.unknown': 'Unknown',
    'logs.bluetooth.emptySessions': 'No sessions found. Try aggregating sessions or adjusting the time range.',
    'logs.bluetooth.emptySessionsWithFile': 'No sessions found for this log file. Try adjusting range or filters.',
    'logs.bluetooth.emptyCommandChains': 'No command chains found. Try adjusting the time range.',
    'logs.bluetooth.emptyAnomalies': 'No anomaly patterns detected.',
    'logs.bluetooth.emptyErrors': 'No errors found in the selected time range.',
    'logs.bluetooth.tab.sessions': 'Sessions',
    'logs.bluetooth.tab.commands': 'Commands',
    'logs.bluetooth.tab.anomalies': 'Anomalies',
    'logs.bluetooth.tab.errors': 'Errors',
    'logs.bluetooth.tab.compare': 'Compare',
    'logs.bluetooth.tab.timeline': 'Timeline',
    'logs.bluetooth.tab.events': 'Events',
    'logs.bluetooth.status.scanning': 'Scanning',
    'logs.bluetooth.status.pairing': 'Pairing',
    'logs.bluetooth.status.connecting': 'Connecting',
    'logs.bluetooth.status.connected': 'Connected',
    'logs.bluetooth.status.communicating': 'Communicating',
    'logs.bluetooth.status.disconnected': 'Disconnected',
    'logs.bluetooth.status.timeout': 'Timeout',
    'logs.bluetooth.status.error': 'Error',
    'logs.bluetooth.anomalyType.frequentDisconnect': 'Frequent Disconnect',
    'logs.bluetooth.anomalyType.timeoutRetry': 'Timeout Retry',
    'logs.bluetooth.anomalyType.errorBurst': 'Error Burst',
    'logs.bluetooth.anomalyType.slowConnection': 'Slow Connection',
    'logs.bluetooth.anomalyType.commandFailure': 'Command Failure',
    'logs.bluetooth.sessionDetail': 'Session Detail',
    'logs.bluetooth.sessionOverview': 'Session Overview',
    'logs.bluetooth.missingProjectId': 'Missing projectId parameter.',
    'logs.bluetooth.backToSessions': 'Back to Sessions',
    'logs.bluetooth.viewAllEvents': 'View All Events',
    'logs.bluetooth.noCommandChainsInSession': 'No command chains found in this session.',
    ...
    'logs.files.diagnosis.title': 'Problem Diagnosis',
    'logs.files.diagnosis.description': 'Auto-match known issues for quick troubleshooting',
    'logs.files.diagnosis.noIssues': 'No issues found',
    'logs.files.diagnosis.totalErrors': 'Total errors',
    'logs.files.diagnosis.matchedIssues': 'Matched issues',
    'logs.files.diagnosis.critical': 'Critical',
    'logs.files.diagnosis.warning': 'Warning',
    'logs.files.diagnosis.occurrences': 'occurrences',
    'logs.files.diagnosis.devices': 'devices',
    'logs.files.diagnosis.sessions': 'sessions',
    'logs.files.diagnosis.solution': 'Solution',
    'logs.files.diagnosis.viewEvents': 'View events',
    'logs.files.diagnosis.traceSession': 'Trace session',
    'logs.files.diagnosis.traceDevice': 'Trace device',
    'logs.files.diagnosis.moreIssues': '{count} more issues...',
    'logs.files.diagnosis.unmatchedErrors': 'Found {count} errors, but no known issues matched',
    'logs.files.diagnosis.viewAllErrors': 'View all errors',
    'logs.files.diagnosis.noErrorsFound': 'No error events found',

    'logs.analysis.title': 'Log Analysis Dashboard',
    'logs.analysis.subtitle': 'Automated quality analysis and diagnostics',
    'logs.analysis.invalidLogFileId': 'Invalid log file ID',
    'logs.analysis.actions.reanalyze': 'Re-analyze',
    'logs.analysis.actions.startNow': 'Analyze Now',
    'logs.analysis.actions.retry': 'Retry',
    'logs.analysis.actions.refreshAutomation': 'Refresh automation data',
    'logs.analysis.error.title': 'Analysis Error',
    'logs.analysis.error.retryAnalysis': 'Retry Analysis',
    'logs.analysis.empty.title': 'Not analyzed yet',
    'logs.analysis.empty.description': 'This log file has not been analyzed automatically.',
    'logs.analysis.status.analyzingTitle': 'Analysis in Progress',
    'logs.analysis.status.analyzingDescription':
      'The analysis is currently running. Results will update automatically.',
    'logs.analysis.status.failedTitle': 'Analysis Failed',
    'logs.analysis.status.unknownError': 'Unknown error occurred',
    'logs.analysis.metrics.overallQualityScore': 'Overall Quality Score',
    'logs.analysis.metrics.totalEvents': 'Total Events',
    'logs.analysis.metrics.errors': 'Errors',
    'logs.analysis.metrics.warnings': 'Warnings',
    'logs.analysis.metrics.sessions': 'Sessions',
    'logs.analysis.metrics.devices': 'Devices',
    'logs.analysis.severity.critical': 'Critical',
    'logs.analysis.severity.high': 'High',
    'logs.analysis.severity.medium': 'Medium',
    'logs.analysis.severity.low': 'Low',
    'logs.analysis.assertions.title': 'Assertion Automation',
    'logs.analysis.assertions.actions.installing': 'Installing...',
    'logs.analysis.assertions.actions.installDefaults': 'Install default rules',
    'logs.analysis.assertions.actions.running': 'Running...',
    'logs.analysis.assertions.actions.runNow': 'Run assertions now',
    'logs.analysis.assertions.empty':
      'No assertion runs yet. Install default rules first, then run assertions manually.',
    'logs.analysis.assertions.table.triggeredBy': 'Triggered By',
    'logs.analysis.assertions.table.passRate': 'Pass Rate',
    'logs.analysis.assertions.table.passed': 'Passed',
    'logs.analysis.assertions.table.failed': 'Failed',
    'logs.analysis.assertions.pass': 'Pass',
    'logs.analysis.assertions.status.completed': 'Completed',
    'logs.analysis.assertions.status.running': 'Running',
    'logs.analysis.assertions.status.failed': 'Failed',
    'logs.analysis.assertions.trigger.manual': 'Manual',
    'logs.analysis.assertions.trigger.auto': 'Auto',
    'logs.analysis.assertions.summary.installDefaults':
      'Default rules installed: added {created}, skipped {skipped}.',
    'logs.analysis.assertions.summary.pass':
      'Assertions passed: {passed}/{total}, pass rate {rate}%.',
    'logs.analysis.assertions.summary.fail':
      'Assertions failed: {failed}/{total} rules failed.',
    'logs.analysis.projectContextLoading': 'Resolving project context, please try again shortly.',
    'logs.analysis.regression.title': 'Regression Trend (vs Baseline)',
    'logs.analysis.regression.baselineMissingHint':
      'No active regression baseline found. Create one first to view the trend.',
    'logs.analysis.regression.baselineLabel': 'Baseline: {baseline}',
    'logs.analysis.regression.thresholdHint':
      'Max Quality drop {qualityDrop}, Max ErrorRate increase {errorRateIncrease}',
    'logs.analysis.regression.pass': 'Pass',
    'logs.analysis.regression.failWithCount': 'Fail ({count})',
    'logs.analysis.regression.deltaQuality': 'Δ quality:',
    'logs.analysis.regression.deltaErrorRate': 'Δ errorRate:',
    'logs.analysis.regression.deltaErrors': 'Δ errors:',
    'logs.analysis.regression.deltaWarnings': 'Δ warnings:',
    'logs.analysis.regression.topViolation': 'Top violation: {message}',
    'logs.analysis.reasonCode.title': 'ReasonCode Classification',
    'logs.analysis.reasonCode.subtitle':
      'Aggregate reasonCode and classify by stage/op/result to locate dominant failure causes.',
    'logs.analysis.reasonCode.totalTagged': 'Tagged reasonCode events',
    'logs.analysis.reasonCode.coverage': 'Coverage',
    'logs.analysis.reasonCode.missing': 'Missing reasonCode',
    'logs.analysis.reasonCode.unique': 'Unique reason codes',
    'logs.analysis.reasonCode.topReasons': 'Top reason codes',
    'logs.analysis.reasonCode.categories': 'Category distribution',
    'logs.analysis.reasonCode.stageOpResult': 'Top stage/op/result combinations',
    'logs.analysis.reasonCode.empty': 'No aggregatable reasonCode events in this log file.',
    'logs.analysis.reasonCode.reason': 'reasonCode',
    'logs.analysis.reasonCode.category': 'Category',
    'logs.analysis.reasonCode.count': 'Count',
    'logs.analysis.reasonCode.ratio': 'Ratio',
    'logs.analysis.reasonCode.topReasonHint': 'Top: {reasonCode} ({count})',
    'logs.analysis.reasonCode.unknownValue': '-',
    'logs.analysis.reasonCode.category.timeout': 'Timeout',
    'logs.analysis.reasonCode.category.permission': 'Permission/Auth',
    'logs.analysis.reasonCode.category.network': 'Network/Cloud',
    'logs.analysis.reasonCode.category.bluetooth': 'Bluetooth',
    'logs.analysis.reasonCode.category.data': 'Data/Upload',
    'logs.analysis.reasonCode.category.session': 'Session',
    'logs.analysis.reasonCode.category.device': 'Device Identity',
    'logs.analysis.reasonCode.category.unknown': 'Other',
    'logs.analysis.ble.title': 'BLE Quality Report',
    'logs.analysis.ble.coverage': 'Coverage',
    'logs.analysis.ble.requiredEvents': 'Required Events',
    'logs.analysis.ble.ok': 'OK',
    'logs.analysis.ble.missing': 'Missing',
    'logs.analysis.ble.parserErrors': 'Parser Errors',
    'logs.analysis.ble.loganDecryption': 'Logan Decryption',
    'logs.analysis.ble.succeeded': 'Succeeded',
    'logs.analysis.backend.title': 'Backend Quality Report',
    'logs.analysis.backend.httpRequests': 'HTTP Requests',
    'logs.analysis.backend.total': 'Total',
    'logs.analysis.backend.success': 'Success',
    'logs.analysis.backend.failed': 'Failed',
    'logs.analysis.backend.successRate': 'Success Rate',
    'logs.analysis.backend.mqtt': 'MQTT',
    'logs.analysis.backend.connected': 'Connected',
    'logs.analysis.backend.publishSuccess': 'Publish Success',
    'logs.analysis.backend.publishFailed': 'Publish Failed',
    'logs.analysis.backend.ackTimeout': 'ACK Timeout',
    'logs.analysis.anomalies.title': 'Detected Anomalies ({count})',
    'logs.analysis.anomalies.occurrences': '{count} occurrences',
    'logs.analysis.anomalies.affectedSessions': 'Affected sessions: {count}',
    'logs.analysis.knownIssues.title': 'Known Issues Matched ({count})',
    'logs.analysis.knownIssues.confidence': '{percent}% confidence',
    'logs.analysis.knownIssues.solution': 'Solution',
    'logs.analysis.knownIssues.matchedEvents': 'Matched {count} events',
    'logs.eventFlow.title': 'Event Flow Analysis',
    'logs.eventFlow.subtitle': 'Analyze event chains and coverage within the log file',
    'logs.eventFlow.loading': 'Loading event flow analysis...',
    'logs.eventFlow.loadFailed': 'Load failed',
    'logs.eventFlow.emptyTitle': 'No data',
    'logs.eventFlow.emptyDescription': 'This log file has not run event flow analysis yet',
    'logs.eventFlow.analyzeNow': 'Analyze now',
    'logs.eventFlow.triggerFailed': 'Failed to trigger analysis',
    'logs.eventFlow.unknownError': 'Unknown error',
    'logs.eventFlow.tab.mainFlow': 'Main flow',
    'logs.eventFlow.tab.coverage': 'Coverage',
    'logs.eventFlow.common.na': 'N/A',
    'logs.eventFlow.mainFlow.totalSessions': 'Total sessions',
    'logs.eventFlow.mainFlow.completedSessions': 'Completed sessions',
    'logs.eventFlow.mainFlow.completionRate': 'Completion rate',
    'logs.eventFlow.mainFlow.avgDuration': 'Avg duration',
    'logs.eventFlow.mainFlow.stageAnalysis': 'Stage analysis',
    'logs.eventFlow.mainFlow.sampleSessions.title': 'Sample sessions',
    'logs.eventFlow.mainFlow.sampleSessions.description':
      'Show detailed analysis results for part of sessions',
    'logs.eventFlow.mainFlow.table.linkCode': 'LinkCode',
    'logs.eventFlow.mainFlow.table.deviceMac': 'Device MAC',
    'logs.eventFlow.mainFlow.table.totalDuration': 'Total duration',
    'logs.eventFlow.mainFlow.table.completedStages': 'Completed stages',
    'logs.eventFlow.mainFlow.table.coverage': 'Coverage',
    'logs.eventFlow.mainFlow.table.status': 'Status',
    'logs.eventFlow.mainFlow.status.completed': 'Completed',
    'logs.eventFlow.mainFlow.status.incomplete': 'Incomplete',
    'logs.eventFlow.stage.required': 'Required',
    'logs.eventFlow.stage.expectedDuration': 'Expected duration',
    'logs.eventFlow.stage.sessions': '{covered} / {total} sessions',
    'logs.eventFlow.stage.avgDuration': 'Avg duration',
    'logs.eventFlow.stage.maxDuration': 'Max duration',
    'logs.eventFlow.stage.minDuration': 'Min duration',
    'logs.eventFlow.stage.eventsList': 'Event list',
    'logs.eventFlow.stage.table.eventName': 'Event name',
    'logs.eventFlow.stage.table.required': 'Required',
    'logs.eventFlow.stage.table.occurrenceCount': 'Occurrences',
    'logs.eventFlow.stage.table.hitSessions': 'Hit sessions',
    'logs.eventFlow.stage.table.missedSessions': 'Missed sessions',
    'logs.eventFlow.stage.table.hitRate': 'Hit rate',
    'logs.eventFlow.stage.optional': 'Optional',
    'logs.eventFlow.stage.issuesTitle': 'Issues found',
    'logs.eventFlow.stage.severity': 'Severity: {severity}',
    'logs.eventFlow.stage.affectedSessions': 'Affected sessions: {count}',
    'logs.eventFlow.coverage.totalEvents': 'Total events',
    'logs.eventFlow.coverage.knownEvents': 'Known events',
    'logs.eventFlow.coverage.coveredEvents': 'Covered events',
    'logs.eventFlow.coverage.missingCount': 'Missing {count}',
    'logs.eventFlow.coverage.coverageRate': 'Coverage',
    'logs.eventFlow.coverage.categoryCoverage': 'Category coverage',
    'logs.eventFlow.coverage.extraEvents.title': 'Extra events',
    'logs.eventFlow.coverage.extraEvents.description':
      'Events that appear in logs but are not in the known event list ({count} total)',
    'logs.eventFlow.coverage.extraEvents.table.eventName': 'Event name',
    'logs.eventFlow.coverage.extraEvents.table.occurrenceCount': 'Occurrences',
    'logs.eventFlow.coverage.extraEvents.showingLimit':
      'Showing first 20 only, {count} extra events total',
    'logs.eventFlow.coverage.categoryEvents': '{covered} / {total} events',
    'logs.eventFlow.coverage.categoryTable.eventName': 'Event name',
    'logs.eventFlow.coverage.categoryTable.level': 'Level',
    'logs.eventFlow.coverage.categoryTable.description': 'Description',
    'logs.eventFlow.coverage.categoryTable.occurrenceCount': 'Occurrences',
    'logs.eventFlow.coverage.categoryTable.status': 'Status',
    'logs.eventFlow.coverage.status.covered': 'Covered',
    'logs.eventFlow.coverage.status.missing': 'Not found',
  },
};
