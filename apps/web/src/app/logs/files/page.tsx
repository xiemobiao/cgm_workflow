...
import { FileText, RefreshCw, ChevronRight, Clock, CheckCircle2, XCircle, Loader2, AlertCircle, Activity, AlertTriangle, Trash2 } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeIn}>
        <PageHeader
          title={t('logs.files.title')}
          subtitle={t('logs.files.browse')}
          actions={(
            <PageHeaderActionButton asChild>
              <Link href="/logs">{t('logs.files.backToLogs')}</Link>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Input
                  ...
                  className="h-8 w-20 bg-card/50 px-2 text-sm"
                />
              </div>
              <PageHeaderActionButton
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-white/[0.06]">
                        <th className="w-12 px-3 py-3 text-center text-xs font-medium text-muted-foreground">
                          <Checkbox
