...
export class LogsHelperService {
     ...
     */
    async assertLogFileInProject(params: { projectId: string; logFileId: string }): Promise<void> {
     ...
     */
    extractCommandInfo(msgJson: unknown): { commandName: string | null; commandCode: string | null } {
