...
describe('buildStreamSessionQualityReport', () => {
  it('summarizes session events and parses fields from msgJson', () => {
    const report = buildStreamSessionQualityReport({
      ...
      events: [
        ...
        },
        {
          ...
          linkCode: 'lc-1',
          requestId: '',
          msgJson: 'reason:disconnectDueToDataIssue rawStartIndex:200 sessionStartIndex:200',
        },
        {
          timestampMs: 1200,
          deviceSn: null,
    ...
    expect(reasons).toEqual(['disconnectDueToDataIssue:1', 'releaseFetchSession:1']);
